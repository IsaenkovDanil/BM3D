...
CBM3D::CBM3D(
	int w_, // ширина
	int h_, // высота
	int max_sim, // максимальное количество похожих патчей
	int psize_, // размер эталонного патча
	int pstep_, // шаг эталонного патча
	int swinrh_, // радиус окна горизонтального поиска
	int ssteph_, // шаг горизонтального поиска
	int swinrv_, // радиус окна вертикального поиска
	int sstepv_ // шаг вертикального поиска
