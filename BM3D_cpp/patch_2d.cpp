...
void Patch2D::transform_2d(int i)
{if (i==0)
	
	//inplace_forward_bior15_2d_8x8(values);
   Iinplace_forward_bior15_2d_8x8(values);

else
inplace_forward_dct_8x8(values);



}

void Patch2D::inv_transform_2d(int i)
{if (i==0)
	
	//inplace_backward_bior15_2d_8x8(values);
Iinplace_backward_bior15_2d_8x8(values);

else
inplace_backward_dct_8x8(values);
